...
/**
 * Defines a ContentPanel to be included in the SideNavigator. Optionally includes an inset JComponent as well for
 * display in the lower region of the side navigator. Provides access to an API similar to
 * {@link org.yamcs.ui.archivebrowser.ArchiveIndexListener} but with a finished event that only triggers when *both*
...
public abstract class NavigatorItem {
    ...
    /**
     * @return a multiplier indicating the indent level of the label name in the SideNavigator (defaults to 0)
     */
     ...
     * 
     * @return optional panel to be put in the lower part of the SideNavigator when this NavigatorItem is active
     */
