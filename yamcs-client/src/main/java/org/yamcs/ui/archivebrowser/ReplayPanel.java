...
public class ReplayPanel extends JPanel {
    protected JLabel replayStartLabel, replayCurrentLabel, replayStopLabel, channelNameLabel, replayStatusLabel,
            replaySpeedLabel;
    ...
    private void updateReplayPanel() {
        ...
        if (rr.hasUtcStart()) {
            replayStartLabel.setText(rr.getUtcStart());
        } else {
            replayStartLabel.setText(TimeEncoding.toString(rr.getStart()));
        }
        if (rr.hasUtcStop()) {
            replayStopLabel.setText(rr.getUtcStop());
        } else {
