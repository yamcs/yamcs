  ...
  final public DataType BasicDataTypeDefinition() throws ParseException {
    ...
    case K_PARAMETER_VALUE:
      jj_consume_token(K_PARAMETER_VALUE);
                          {if (true) return DataType.PARAMETER_VALUE;}
      break;
    case K_STRING:
...
// Expression and it's childs
  ...
  final public Expression PrimaryExpression() throws ParseException, StreamSqlException {
    ...
    case S_QMARK:
      jj_consume_token(S_QMARK);
               {if (true) return new ValueExpression(nextArg());}
      break;
    default:
      jj_la1[46] = jj_gen;
...
/* ----------- SQL productions start here ----------------- */
  final public SelectExpression SelectStatement() throws ParseException, StreamSqlException {
...
/* Checks for whatever follows  SELECT */
  ...
  final public List<Expression> FunctionArgumentList() throws ParseException, StreamSqlException {
