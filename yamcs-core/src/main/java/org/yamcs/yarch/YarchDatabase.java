...
public class YarchDatabase {
            ...
            for(File f:dirFiles) {
                ...
                if(fn.endsWith(".def")) {
                    try {
                        ...
                        mngService.registerTable(dbname, tblDef);
    ...
    public void createTable(TableDefinition def) throws YarchException {
        ...
        if(mngService!=null) {
            mngService.registerTable(dbname, def);
        }
    }
    ...
    public void addStream(AbstractStream stream) throws YarchException {
        ...
        if(mngService!=null) {
            mngService.registerStream(dbname, stream);
        }
    }
    ...
    public void dropTable(String tblName) throws YarchException {
        ...
        if(mngService!=null) {
            mngService.unregisterTable(dbname, tblName);
        }
    ...
    public synchronized void removeStream(String name) {
        ...
        if((s!=null) &&  (mngService!=null)) {
            mngService.unregisterStream(dbname, name);
        }
    }
