...
public class RdbTableWriter extends TableWriter {
    ...
    public void onTuple(Stream stream, Tuple t) {
        try {
            ...
            YRDB db = rdbFactory.getRdb(tableDefinition.getDataDir()+"/"+partition.dir, new ColumnValueSerializer(tableDefinition.getPartitioningSpec().getValueColumnType()), false);
