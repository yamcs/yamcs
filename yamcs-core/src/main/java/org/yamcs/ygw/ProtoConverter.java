...
public class ProtoConverter {
    static org.yamcs.ygw.protobuf.Ygw.PreparedCommand toProto(PreparedCommand pc) {
        org.yamcs.ygw.protobuf.Ygw.PreparedCommand.Builder ypcb = org.yamcs.ygw.protobuf.Ygw.PreparedCommand
                .newBuilder()
    ...
    static Timestamp toProto(org.yamcs.parameter.TimestampValue tv) {
        return Timestamp.newBuilder().setMillis(tv.millis()).setPicos(tv.picos()).build();
    }
}
