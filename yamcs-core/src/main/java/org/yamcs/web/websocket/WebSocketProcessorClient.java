...
public class WebSocketProcessorClient implements ProcessorClient, ManagementListener {
        ...
        if(state==State.RUNNING) {
            ...
            if(processor==null) {
                ...
                try {
                    ...
                    log.error("Error when switching client to new instance {} processor {} ", instanceName, processor.getName(), e);
                } 
            }
        }
        sendConnectionInfo();
    ...
    private void sendConnectionInfo() {
        ...
        try {
            wsHandler.sendData(ProtoDataType.CONNECTION_INFO, conninf.build(), SchemaWeb.ConnectionInfo.WRITE);
        } catch (IOException e) {
