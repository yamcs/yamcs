...
public class ManagementRequestHandler extends AbstractRestRequestHandler {
    ...
    public void handleRequest(ChannelHandlerContext ctx, FullHttpRequest req, String yamcsInstance, String remainingUri) throws RestException {
        ...
        if("processor".equals(qsDecoder.path())) {
            handleProcessorManagementRequest(ctx, req, yamcsInstance, qsDecoder);
        } else {
    ...
    private void handleProcessorManagementRequest(ChannelHandlerContext ctx, FullHttpRequest req, String yamcsInstance,  QueryStringDecoder qsDecoder) throws RestException {
