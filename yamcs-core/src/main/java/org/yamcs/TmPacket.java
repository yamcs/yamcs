...
public class TmPacket {
    ...
    private Instant gentime = Instant.INVALID_INSTANT; // generation time
    ...
    /**
     * @deprecated use {@link #TmPacket(long, Instant, int, byte[])} for full picosecond resolution
     */
    @Deprecated
    public TmPacket(long rectime, long gentime, int seqCount, byte[] pkt) {
        this.rectime = rectime;
        this.gentime = Instant.get(gentime);
        this.seqCount = seqCount;
        this.pkt = pkt;
    }

    public TmPacket(long rectime, Instant gentime, int seqCount, byte[] pkt) {
        this.rectime = rectime;
    ...
    /**
     * The time when the packet has been generated by the payload, in milliseconds.
     *
    ...
    public void setGenerationTime(long time) {
        this.gentime = Instant.get(time);
    }

    public void setGenerationTime(Instant time) {
        this.gentime = time;
    }
