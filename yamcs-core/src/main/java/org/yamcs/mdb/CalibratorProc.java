 ...
 * <p>
 * Also starting with Yamcs 5.12, the calibrators get access to the {@link ProcessingData} allowing them to lookup other
...
public interface CalibratorProc {
     ...
     * 
     */
    public abstract Value calibrate(Value v, ProcessingData pdata) throws XtceProcessingException;
}
