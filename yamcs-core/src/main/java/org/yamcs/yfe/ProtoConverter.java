...
public class ProtoConverter {
    static org.yamcs.yfe.protobuf.Yfe.PreparedCommand toProto(PreparedCommand pc) {
        org.yamcs.yfe.protobuf.Yfe.PreparedCommand.Builder ypcb = org.yamcs.yfe.protobuf.Yfe.PreparedCommand.newBuilder()
    ...
    static org.yamcs.parameter.Value fromProto(AggregateValue protoAggregateValue) {
        ...
        protoAggregateValue.getNameList().forEach((name) -> aggrTypeBuilder.addMember(new Member(name)));
    ...
    static org.yamcs.parameter.Value fromProto(EnumeratedValue protoEnumeratedValue) {
        ...
        org.yamcs.parameter.EnumeratedValue enumeratedValue = new org.yamcs.parameter.EnumeratedValue(longValue,
                stringValue);
    ...
    static org.yamcs.parameter.Value fromProto(ArrayValue protoArrayValue) {
        ...
        org.yamcs.parameter.ArrayValue arrval = new org.yamcs.parameter.ArrayValue(dimensions,
                convertType(protoArrayValue.getValue(0)));
