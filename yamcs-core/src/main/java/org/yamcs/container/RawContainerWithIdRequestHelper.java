 ...
 *
 */
public class RawContainerWithIdRequestHelper implements RawContainerConsumer {
    RawContainerRequestManager crm;
    final RawContainerWithIdConsumer listener;
    Logger log=LoggerFactory.getLogger(this.getClass().getName());
    List<ContainerWithId> subscription = new  ArrayList<ContainerWithId>();
    
    

    public RawContainerWithIdRequestHelper(RawContainerRequestManager crm, RawContainerWithIdConsumer listener) {
	this.crm = crm;
    ...
    public synchronized void subscribeAll(RawContainerWithIdConsumer subscriber) {
