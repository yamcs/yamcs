...
public class SubServiceNine extends BucketSaveHandler implements PusSubService {
    ...
    public TmPacket process(PusTmPacket pusTmPacket) {
        ...
        try {
            ...
            throw new UncheckedIOException("Cannot save / update device register dump report in bucket: " + physicalDeviceReportName + (physicalDeviceReportBucket != null ? " -> " + physicalDeviceReportBucket.getName() : ""), e);
        }
