 ...
 * 
 */
public class YamcsCascading extends AbstractService implements MessageHandler, ArchiveTmPacketProvider, ParameterProvider {
    ...
    EndAction endAction;
    static Logger log=LoggerFactory.getLogger(YamcsCascading.class.getName());
    ...
    public YamcsCascading(String instance, String spec) throws ChannelException, ConfigurationException {
    ...
    public void onMessage(ClientMessage msg) {
        try {
            ...
            case TM_PACKET:
                ...
                tmProcessor.processPacket(new PacketWithTime(tpd.getReceptionTime(), tpd.getGenerationTime(), tpd.getPacket().asReadOnlyByteBuffer()));
                break;
            case PP:
                ...
                for(org.yamcs.protobuf.Pvalue.ParameterValue pbPv:pd.getParameterList()) {
                    ProcessedParameterDefinition ppDef=ppdb.getProcessedParameter(pbPv.getId().getName());
