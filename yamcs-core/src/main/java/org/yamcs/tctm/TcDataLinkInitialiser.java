...
public class TcDataLinkInitialiser extends AbstractService {
    ...
    public TcDataLinkInitialiser(String yamcsInstance)
            throws StreamSqlException, ParseException, YamcsApiException, IOException {
        ...
        for (Object o : uplinkers) {
            ...
            if (tclinks.containsKey(name)) {
                throw new ConfigurationException(
                        "Instance " + yamcsInstance + ": there is already a TC Link by name '" + name + "'");
            }
