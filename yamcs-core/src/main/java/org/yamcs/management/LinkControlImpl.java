...
public class LinkControlImpl extends StandardMBean implements LinkControl {
	...
	/** returns true if the link status or datacount has changed since the creation or since the previous call of this method**/
    public boolean hasChanged() {
        if(!linkInfo.getStatus().equals(link.getLinkStatus())
                ...
                || linkInfo.getDetailedStatus()!=link.getDetailedStatus()) {
