...
public class YamcsServerInstance extends AbstractService {
    ...
    public List<ServiceInfo> getServices() {
        return YamcsServer.getServiceInfo(instanceName, serviceList);
    }
    /**
    ...
    protected void doStop() {
        for(int i = serviceList.size()-1; i>=0; i--) {
            ...
            try {
                ...
                log.error("Service {} did not stop in {} seconds", s.getClass().getName(),  YamcsServer.SERVICE_STOP_GRACE_TIME);
