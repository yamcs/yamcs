...
public class YObjectLoader<T> {
   ...
   static public <T> T loadObject(String className, Object... args) throws ConfigurationException, IOException {
     ...
     * 
     * If args is present, then a constructor with the given type is invoked otherwise the constructor without any argument is invoked.
     * 
     * 
     * @param conf
     * @return a new object
     ...
     * @throws IOException
     */
    static public <T> T loadObject(Map<String, Object> conf, Object firstArg) throws ConfigurationException, IOException {
        String className = YConfiguration.getString(conf, "class");
        Object args = getArgs(conf);
     ...
     * @throws IOException
     */
    static public <T> T loadObject(Map<String, Object> conf, Object firstArg, Object secondArg) throws ConfigurationException, IOException {
        String className = YConfiguration.getString(conf, "class");
        Object args = getArgs(conf);
