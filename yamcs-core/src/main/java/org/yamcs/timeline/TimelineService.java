...
public class TimelineService extends AbstractYamcsService {
    ...
    public Spec getSpec() {
        var spec = new Spec();
        // Deprecated. Deprecation message is generated by ActivityService
        spec.addOption(CONFIG_ACTIVITIES, OptionType.MAP).withSpec(Spec.ANY);
    ...
    protected void doStart() {
        serviceManager = new ServiceManager(Arrays.asList(activityScheduler));
        try {
