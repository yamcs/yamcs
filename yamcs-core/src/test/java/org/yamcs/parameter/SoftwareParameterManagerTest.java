...
public class SoftwareParameterManagerTest {
	...
	public void test() throws Exception {
		...
		org.yamcs.protobuf.Pvalue.ParameterValue pv1 = org.yamcs.protobuf.Pvalue.ParameterValue.newBuilder().setId(p1id)
				.setEngValue(p1v).build();
		org.yamcs.protobuf.Pvalue.ParameterValue pv2 = org.yamcs.protobuf.Pvalue.ParameterValue.newBuilder().setId(p2id)
				.setEngValue(p2v).build();
