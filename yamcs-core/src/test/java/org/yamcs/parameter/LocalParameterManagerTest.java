...
public class LocalParameterManagerTest {
    ...
    public void test() throws Exception {
        LocalParameterManager spm = new LocalParameterManager("test", YConfiguration.emptyConfig());
    ...
    class MyParamConsumer implements ParameterListener {
        BlockingQueue<Collection<ParameterValue>> received = new LinkedBlockingQueue<>();
