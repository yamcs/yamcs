...
public class IntValueSegmentTest {
    ...
    public void test256() {
        ...
        fastpfor.compress(data, inputoffset, N, compressedoutput, outputoffset);

        long expected[] = { 256, 125, 2, 2147483649l, 1744830462, 4093640703l, 570425343, 503316480, 419430400,
                260046848,
                171966464, 98566144, 59768832, 33030144, 19136512, 10354688, 5832704, 3112960, 1720320, 909312, 495616,
                260096, 140288, 73216, 39168, 20352, 10816, 5600, 2960, 1528, 804, 414, 2147483865l, 1073741935,
                3758096442l, 2415919133l, 4160749583l, 603979783, 503316484, 419430402, 2407530497l, 1245708288,
                635437056, 328204288, 167247872, 86245376, 43909120, 22609920, 11501568, 5914624, 3006464, 1544192,
                784384, 402432, 204288, 104704, 53120, 27200, 13792, 7056, 3576, 1828, 926, 2147484121l, 1073742063,
                3758096506l, 2415919165l, 4160749599l, 603979791, 503316488, 419430404, 260046850, 2319450113l,
                1172307968, 596639744, 301465600, 153354240, 77463552, 39387136, 19890176, 10108928, 5103616, 2592768,
                1308672, 664576, 335360, 170240, 85888, 43584, 21984, 11152, 5624, 2852, 1438, 2147484377l, 1073742191,
                3758096570l, 2415919197l, 4160749615l, 603979799, 503316492, 419430406, 2407530499l, 3393191937l,
                1709178880, 865075200, 435683328, 220463104, 111017984, 56164352, 28278784, 14303232, 7200768, 3641344,
                1832960, 926720, 466432, 235776, 118656, 59968, 30176, 15248, 7672, 3876, 1950, 1073738313, 7, 33554463,
                65548, 2048, 2, 8200096 };
        for (var i = 0; i < outputoffset.intValue(); i++) {
            assertEquals((int) expected[i], compressedoutput[i]);
        }
    }
