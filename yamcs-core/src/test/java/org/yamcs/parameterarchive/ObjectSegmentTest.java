...
public class ObjectSegmentTest {
    ...
    public void test() throws DecodingException {
        ...
        assertEquals(pv.getCriticalRange().getMaxInclusive(), s.getAlarmRange(0).getMaxInclusive(), 1e-10);
        assertEquals(pv.getCriticalRange().getMinInclusive(), s.getAlarmRange(0).getMinInclusive(), 1e-10);
        ...
        assertEquals(pv.getWarningRange().getMaxInclusive(), s2.getAlarmRange(0).getMaxInclusive(), 1e-10);
        assertEquals(pv.getWarningRange().getMinInclusive(), s2.getAlarmRange(0).getMinInclusive(), 1e-10);
        assertEquals(pv.getCriticalRange().getMaxInclusive(), s2.getAlarmRange(1).getMaxInclusive(), 1e-10);
        assertEquals(pv.getCriticalRange().getMinInclusive(), s2.getAlarmRange(1).getMinInclusive(), 1e-10);
