...
public class TimeCorrelationServiceTest {
    ...
    public void testExceededAccuracy() throws Exception {
        ...
        ots.addSample(3, Instant.get(4200, 0));//this will cause the coefficients to be recomputed based on the last two samples
    ...
    public void testExceededValidity() throws Exception {
        ...
        ots.addSample(3, Instant.get(5000, 0));//this will cause the coefficients to be recomputed based on the last two samples
        assertEquals(Instant.INVALID_INSTANT, ots.getTime(0));
    }
