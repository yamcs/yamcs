...
@Component({
  selector: 'app-add-stacked-command-dialog',
  templateUrl: './AddStackedCommandDialog.html',
})
export class AddStackedCommandDialog {

  form = new FormGroup({});
  arguments: Argument[] = [];

  constructor(
    private dialogRef: MatDialogRef<AddStackedCommandDialog>,
