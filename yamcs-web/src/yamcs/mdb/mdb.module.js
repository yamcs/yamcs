(function() {
    ...
    function configure($routeProvider) {
        $routeProvider.when('/mdb', {
            templateUrl: '/_static/yamcs/mdb/pages/index.html',
            controller: 'MDBIndexController',
            controllerAs: 'vm'
        }).when('/mdb/:ss1/parameters', {
            templateUrl: '/_static/yamcs/mdb/pages/parameters.html',
            ...
            templateUrl: '/_static/yamcs/mdb/pages/containers.html',
            ...
            templateUrl: '/_static/yamcs/mdb/pages/commands.html',
            ...
            templateUrl: '/_static/yamcs/mdb/pages/algorithms.html',
            ...
            templateUrl: '/_static/yamcs/mdb/pages/algorithm-detail.html',
            ...
            templateUrl: '/_static/yamcs/mdb/pages/parameter-detail.html',
