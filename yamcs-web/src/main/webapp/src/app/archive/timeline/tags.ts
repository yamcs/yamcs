export class Tag {
   ...
   * @param singleQuotes When true all attributes will get surrounded by single quotes instead of double quotes. This can be useful to avoid URI-encoding bloat.
   */
