...
import { ColumnChooserComponent, ColumnInfo, GetParameterTypesOptions, ParameterType, YamcsService } from '@yamcs/webapp-sdk';
import { BehaviorSubject } from 'rxjs';
import { ParameterTypesDataSource } from './ParameterTypesDataSource';

@Component({
  templateUrl: './ParameterTypesPage.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ParameterTypesPage implements AfterViewInit {
