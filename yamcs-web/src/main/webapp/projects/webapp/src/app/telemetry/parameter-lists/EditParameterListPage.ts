...
import { MessageService, ParameterList, UpdateParameterListRequest, YamcsService } from '@yamcs/webapp-sdk';
import { BehaviorSubject, Subscription } from 'rxjs';
import { SelectParameterDialog } from '../../shared/dialogs/SelectParameterDialog';

@Component({
  templateUrl: './EditParameterListPage.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EditParameterListPage implements OnDestroy {
