...
import { MessageService, ParameterList, YamcsService } from '@yamcs/webapp-sdk';
import { AuthService } from '../../core/services/AuthService';

@Component({
  templateUrl: './ParameterListsPage.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ParameterListsPage implements AfterViewInit {
