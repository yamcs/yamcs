...
import { CreateParameterListRequest, MessageService, YamcsService } from '@yamcs/webapp-sdk';
import { BehaviorSubject } from 'rxjs';
import { SelectParameterDialog } from '../../shared/dialogs/SelectParameterDialog';

@Component({
  templateUrl: './CreateParameterListPage.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CreateParameterListPage {
