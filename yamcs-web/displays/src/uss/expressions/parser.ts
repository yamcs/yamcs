...
function peg$parse(input, options) {
  ...
  const peg$c0 = function(formula) { return formula; };
  ...
  const peg$c2 = function(expression) {
      return {
  ...
  const peg$c81 = function(operator, argument) {
      return {
        type: 'UnaryExpression',
        operator: operator,
        argument: argument,
  ...
  const peg$c86 = function(callee, args) {
      return {
        type: 'CallExpression',
        callee: callee,
        arguments: args
  ...
  const peg$c87 = function(args) {
      return optionalList(extractOptional(args, 0));
    };
  const peg$c88 = ",";
  const peg$c89 = peg$literalExpectation(",", false);
  const peg$c90 = function(head, tail) {
      return buildList(head, tail, 3);
    };
  const peg$c91 = function(argument, operator) {
      return {
        type: 'UnaryExpression',
        operator: operator,
        argument: argument
  ...
  const peg$c102 = function(head, tail) {
        return buildBinaryExpression(head, tail);
      };
  const peg$c103 = function(head, tail) {
      return buildBinaryExpression(head, tail);
    };
  const peg$c104 = "<=";
  ...
  const peg$c118 = function(head, tail) {
       return buildBinaryExpression(head, tail);
    };
  const peg$c119 = "&";
  ...
  const peg$c129 = function(head, tail) {
  ...
  const peg$c134 = function(test, consequent, alternate) {
        return {
  ...
  const peg$c135 = function(test, consequent) {
      return {
        type: 'ConditionalExpression',
        test: test,
        consequent: consequent,
  ...
  const peg$c138 = function(left, right) {
      return {
