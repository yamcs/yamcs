...
The index can be visualized in the Yamcs UI in the :menuselection:`Archive Browser`. It is denoted as :guilabel:`Completeness` and contains one timeline bar for each APID.
