    ...
    public static final class YamcsInstance
    {
        ...
        public static class MessageSchema implements io.protostuff.Schema<org.yamcs.protobuf.YamcsManagement.YamcsInstance>
        {
            public void writeTo(io.protostuff.Output output, org.yamcs.protobuf.YamcsManagement.YamcsInstance message) throws java.io.IOException
            {
                ...
                if(message.hasFailureCause())
                    output.writeString(9, message.getFailureCause(), false);
            }
                ...
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            builder.setFailureCause(input.readString());
                            break;
                        default:
                            input.handleUnknownField(number, this);
                    }
        ...
        public static class MessageSchema implements io.protostuff.Schema<org.yamcs.protobuf.YamcsManagement.HistoryInfo>
        {
            public void writeTo(io.protostuff.Output output, org.yamcs.protobuf.YamcsManagement.HistoryInfo message) throws java.io.IOException
            {
                ...
                if(message.hasAuthor())
                    output.writeString(4, message.getAuthor(), false);
            }
                ...
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            builder.setAuthor(input.readString());
                            break;
                        default:
                            input.handleUnknownField(number, this);
                    }
    ...
    public static final class ProcessorInfo
    {
        ...
        public static class MessageSchema implements io.protostuff.Schema<org.yamcs.protobuf.YamcsManagement.ProcessorInfo>
        {
            public void writeTo(io.protostuff.Output output, org.yamcs.protobuf.YamcsManagement.ProcessorInfo message) throws java.io.IOException
            {
                ...
                if(message.hasHasAlarms())
                    output.writeBool(6, message.getHasAlarms(), false);
                if(message.hasHasCommanding())
                    output.writeBool(7, message.getHasCommanding(), false);
                if(message.hasState())
                    output.writeString(8, message.getState().name(), false);
                if(message.hasReplayRequest())
                    output.writeObject(9, message.getReplayRequest(), org.yamcs.protobuf.SchemaYamcs.ReplayRequest.WRITE, false);

                if(message.hasReplayState())
                    output.writeString(10, message.getReplayState().name(), false);
                if(message.hasUrl())
                    output.writeString(11, message.getUrl(), false);
                if(message.hasClientsUrl())
                    output.writeString(12, message.getClientsUrl(), false);
                if(message.hasParametersUrl())
                    output.writeString(13, message.getParametersUrl(), false);
                if(message.hasCommandsUrl())
                    output.writeString(14, message.getCommandsUrl(), false);
                if(message.hasCommandQueuesUrl())
                    output.writeString(15, message.getCommandQueuesUrl(), false);
            }
                ...
                for(int number = input.readFieldNumber(this);; number = input.readFieldNumber(this))
                {
                    switch(number)
                    {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            builder.setHasAlarms(input.readBool());
                            break;
                        case 7:
        ...
        public static java.lang.String getFieldName(int number)
        {
            switch(number)
            {
                ...
                case 6: return "hasAlarms";
                case 7: return "hasCommanding";
                case 8: return "state";
                case 9: return "replayRequest";
                case 10: return "replayState";
                case 11: return "url";
                case 12: return "clientsUrl";
                case 13: return "parametersUrl";
                case 14: return "commandsUrl";
                case 15: return "commandQueuesUrl";
                default: return null;
            }
        }
        public static int getFieldNumber(java.lang.String name)
        ...
        static
        {
            ...
            fieldMap.put("hasAlarms", 6);
            fieldMap.put("hasCommanding", 7);
            fieldMap.put("state", 8);
            fieldMap.put("replayRequest", 9);
            fieldMap.put("replayState", 10);
            fieldMap.put("url", 11);
            fieldMap.put("clientsUrl", 12);
            fieldMap.put("parametersUrl", 13);
            fieldMap.put("commandsUrl", 14);
            fieldMap.put("commandQueuesUrl", 15);
        }
    }
