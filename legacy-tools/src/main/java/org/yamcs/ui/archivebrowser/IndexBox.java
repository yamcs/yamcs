...
public class IndexBox extends Box implements MouseListener {
    ...
    JMenuItem removePacketMenuItem, removeExceptPacketMenuItem, removePayloadMenuItem, changeColorMenuItem,
            copyOpsnameMenuItem;
    ...
    protected void buildPopup() {
        if (groups.isEmpty()) {
            ...
            for (final String key : plkeys) {
                ...
                menuItem.addActionListener(e -> enableAllPackets(key));
                submenu.add(menuItem);
            }
        }
    }
    ...
    void updatePrefsVisiblePackets() {
        ArrayList<String> visiblePackets = new ArrayList<>();
    ...
    class IndexLineSpec implements Comparable<IndexLineSpec>, ActionListener {
        ...
        public void newColor() {
            color = new Color((float) (Math.random() * 0.4 + 0.2), (float) (Math.random() * 0.4 + 0.2),
