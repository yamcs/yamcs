...
public class PrefsToolbar extends JPanel {
    ...
    void loadFromPrefs() {
        datePicker.setStartTimestamp(prefs.getLong("rangeStart", TimeEncoding.getWallclockTime() - 30 * 24 * 3600));
        datePicker.setEndTimestamp(prefs.getLong("rangeEnd", TimeEncoding.getWallclockTime()));
    }
