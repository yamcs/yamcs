...
final class GlobUtils {
    ...
    /**
     * Transforms globbing expression into regular expression. Currently these characters have special meaning in the
     * globbing expression: ? (one arbitrary character), * (sequence of arbitrary characters)
     * 
     * @todo This method do not translates all other special characters in the globbing string which can have special
     *       meaning in regular expression.
     * @param glob
     *            Glob expression to be transformed into regexp.
